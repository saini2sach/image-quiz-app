    ...
    return (
        <div className="col-10 offset-1 main-content clearfix">
            ...
            { props.imageUrl 
                ...
                : <div className="col-md-5 float-right item-options option-loader">
                    <div className="loader"></div>
                  </div>
            }
        </div>
